...
class tangent:
    ...
    def Calc_mu_nu(self):
        ...
        #lambdaを求める
        nu = 1/2*np.sqrt( (-Zdif_u0_divide_u0_u0**2 + Zdif_u0_2_divide_u0_u0*divide_u0_u0) / (self.P*divide_u0_u0 - self.Delta**2 / self.omega**2))
        #muを求める
        mu = (self.omega*Zdif_u0_divide_u0_u0-2*nu*self.Delta)/(self.omega**2*divide_u0_u0)
        return mu.item(), nu.item()
