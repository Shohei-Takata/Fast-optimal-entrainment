...
plt.plot(VAN_simple[0,:],VAN_simple[1,:], label="simple(P=0.001)", color='orange')
plt.plot(VAN_simple2[0,:],VAN_simple2[1,:], label="simple(P=0.1)", color='c')
plt.plot(VAN_feedback[0,:],VAN_feedback[1,:], label='with feedback(P=0.1)', color='darkblue')
plt.plot(VAN_penalty[0,:],VAN_penalty[1,:], color='lawngreen', alpha = 0.7, label="with penalty(P=0.1)")
plt.plot(X0_[0,:],X0_[1,:], label='limit cycle', linestyle='--', color='r')
...
plt.plot(VAN_simple_a[0,:],VAN_simple_a[1,:], label="simple(P=0.001)", color='orange')
plt.plot(VAN_simple2_a[0,:],VAN_simple2_a[1,:], label="simple(P=0.1)", color='c')
plt.plot(VAN_feedback_a[0,:],VAN_feedback_a[1,:], label='with feedback(P=0.1)', color='darkblue')
plt.plot(VAN_penalty_a[0,:],VAN_penalty_a[1,:], color='lawngreen', label="with penalty(P=0.1)")
...
plt.plot(X0_[0,:],X0_[1,:], label='limit cycle', linestyle='--', color='r')
plt.plot(VAN_simple[0,:],VAN_simple[1,:], label='without penalty', color='orange')
plt.plot(VAN_penalty[0,:],VAN_penalty[1,:], color='brown', label='with penalty k=5', alpha = 0.8)
plt.plot(VAN_penalty2[0,:],VAN_penalty2[1,:], color='m', label='with penalty k=10', alpha = 0.6)
plt.plot(VAN_penalty3[0,:],VAN_penalty3[1,:], color='b', label='with penalty k=50')
...
plt.plot(VAN_penalty_a[0,:],VAN_penalty_a[1,:], color='brown',linestyle = '-', label='with penalty k=5', linewidth=2.0)
plt.plot(VAN_penalty2_a[0,:],VAN_penalty2_a[1,:], color='m',linestyle = '-', label='with penalty k=10', linewidth=2.0)
plt.plot(VAN_penalty3_a[0,:],VAN_penalty3_a[1,:], color='b',linestyle = '-', label='with penalty k=50', linewidth=2.0)
...
plt.plot(Time_ax, VAN_penalty[0,:], color='brown', label='with penalty k=5', alpha = 0.8)
plt.plot(Time_ax, VAN_penalty2[0,:], color='m', label='with penalty k=10', alpha = 0.6)
plt.plot(Time_ax, VAN_penalty3[0,:], color='b', label='with penalty k=50')
...
plt.plot(Time_ax, VAN_penalty[1,:], color='brown', label='with penalty k=5', alpha = 0.8)
plt.plot(Time_ax, VAN_penalty2[1,:], color='m', label='with penalty k=10', alpha = 0.6)
plt.plot(Time_ax, VAN_penalty3[1,:], color='b', label='with penalty k=50')
